namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
           ...
           StringBuilder sb = new StringBuilder();
            ...
            foreach (ImportProjectDto projectDto in projectDtos)
            {
                ...
                bool isOpenDateValid = DateTime.TryParseExact(projectDto.OpenDate, "dd/MM/yyyy",
                    CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime openTime);
                if (!isOpenDateValid)
                {
                    sb.AppendLine(ErrorMessage);
                    continue;
        ...
        public static string ImportEmployees(TeisterMaskContext context, string jsonString)
        {
            ...
            ImportEmployeesDto[] employeesDtos = JsonConvert.DeserializeObject<ImportEmployeesDto[]>(jsonString);
